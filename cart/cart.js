...
import { render } from "../utils/render.jsw";
...
const buildTelegramLink = (orderText, user) => {
    ...
    return `https://t.me/lgramUsername?text=telegramUsername?text={encodedText}`
}
...
export{ getUserData,waitForTelegram,showPreloader,hidePreloader,waitForTelegramReady,setPreloderTex}